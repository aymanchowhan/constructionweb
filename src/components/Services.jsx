...
function Services() {
    ...
    return (
        <div id='services' className='h-fit bg-pink-100 m-auto container pt-14 lg:pt-[90px] pb-[70px]'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-4 w-fit lg:w-[70%] mx-auto gap-0 pb-10'>
                {
                    data.map((item, index) => (
                        <div className=' p-[20px] mt-14'>
                            ...
                            <div className='text-center text-[14px] text-base p-subtitle text-[#0F1D46] opacity-70'>
                                {item.description}
                            </div>
                        </div>
                    ))
